...
function DetailInfo(props) {
  ...
  useEffect(() => {
    Axios.get(`http://localhost:3003/api/get/PersonalInfo/Details/${id}`).then((response) => {
  ...
  useEffect(() => {
    Axios.get(`http://localhost:3003/api/get/CheckupInfo/Details/${id}/${dateFetch}`).then((response) => {
  ...
  useEffect(() => {
    Axios.get(`http://localhost:3003/api/get/dateList/${id}`).then((response) => {
  ...
  return (
    <div className="DetailInfo">
      ...
      >
        ЗАПИСЬ {personalInfo.name}
      </div>
      <br></br>

      <div className="DateForms">
        <div className="titlecheckupdate">ПРЕДЫДУЩИЕ ПРОВЕРКИ</div>
        {dateList.map((val) => {
          return (
      ...
      <div style={styles.profileInfo}>
        <div className="patientPersonalInfo">
          <h4 style={{ margin: '10pxf' }}>
            ID : {personalInfo.id} <br></br>Имя : {personalInfo.name}
            <br></br> Пол : {personalInfo.gender}
            <br></br> Адрес : {personalInfo.address}
            <br></br> Дата рождения : {personalInfo.dateofBirth}
            <br></br> Группа крови : {personalInfo.bloodType}
          </h4>
        </div>
      </div>
      ...
      <div>
        ...
        <Button variant="contained" color="primary" size="small">
          <h4>Дата поступления:</h4> {latestCheckUpInfo.dateOfAdmission}
        </Button>
        ...
        <div className="patientCheckInfo">
          ...
          <div style={styles.container}>
            <div style={styles.blocktitle}>Жизненные показатели пациента</div>
            <div style={styles.wrappersecondarycont}>
              {/* Latest CheckUp info */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>AД</div>
                <TextField
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>ЧСС</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>ЧД</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Температура</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Масса</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Cатурация</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
          ...
          <div style={styles.container}>
            <div style={styles.blocktitle}>Жалобы и История </div>
            <div style={styles.wrappersecondarycont}>
              {/* Latest CheckUp info */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebelbigger}>жалоба</div>
                <TextField
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebelbigger}>История болезни пациента</div>
                <TextField
                  style={styles.biggertextfield}
                  label=""
                  variant="outlined"
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebelbigger}>Общий вид</div>
                <TextField
                  style={styles.biggertextfield}
                  label=""
                  variant="outlined"
          ...
          <div style={styles.container}>
            <div style={styles.blocktitle}>Физическое обследование </div>
            <div style={styles.wrappersecondarycont}>
              {/* Latest CheckUp info */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Кожа</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Шея</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Голова</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Грудь</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Брюшная полость</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Живот</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Конечности</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
              ...
              <div style={styles.secondContainer}>
                <div style={styles.contLebel}>Нервы</div>
                <TextField
                  style={styles.textfield}
                  label=""
                  variant="outlined"
          ...
          {/* ************************************************* Admitting Diagnosis */}
          <div style={styles.container}>
            <div style={styles.blocktitle}> Диагностика и Лечение</div>
            <div style={styles.wrappersecondarycont}>
              {/* Latest CheckUp info */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebelbigger}> Лечение</div>
                <TextField
                  style={styles.biggertextfield}
                  label=""
                  variant="outlined"
              ...
              {/* here is particition */}
              <div style={styles.secondContainer}>
                <div style={styles.contLebelbigger}> Ведение</div>
                <TextField
                  style={styles.biggertextfield}
                  label=""
                  variant="outlined"
